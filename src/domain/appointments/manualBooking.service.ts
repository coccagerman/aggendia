...
export async function createManualAppointment(
    ...
    sendBusinessConfirmationEmail(prisma, {
        ...
        console.error('[ManualBooking] Unexpected error in sendBusinessConfirmationEmail:', err)
    })
    ...
    sendBusinessConfirmationWhatsApp(prisma, {
        ...
        console.error('[ManualBooking] Unexpected error in sendBusinessConfirmationWhatsApp:', err)
    })
