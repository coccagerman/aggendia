...
function Calendar({ className, classNames, showOutsideDays = true, weekHover = false, ...props }: CalendarProps) {
    return (
        <DayPicker
            locale={es}
            ...
            classNames={{
                ...
                caption_label: 'text-sm font-medium capitalize z-0',
                ...
                week: cn('flex w-full mt-2', weekHover && 'hover:bg-accent/50 rounded-md'),
                day: cn(
