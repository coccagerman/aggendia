 ...
 *
 * Shown when a user's subscription/trial has expired and they
 * need to subscribe to regain access.
 *
 * This page lives OUTSIDE the dashboard layout's subscription gate
 * to avoid a redirect loop (layout redirects here when expired).
 */
