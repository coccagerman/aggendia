...
/**
 * Render cancellation email HTML
                    ...
                    <tr>
                        <td style="padding: 32px 32px 24px 32px; text-align: center; border-bottom: 1px solid #eaeaea;">
                            ...
                            <p style="margin: 0; font-size: 16px; color: #666666;">
                                Hola ${escapeHtml(data.customerName)}, tu turno ha sido cancelado.
                            </p>
                        </td>
                    </tr>
 ...
 */
export function renderCancellationEmailText(data: CancellationEmailData): string {
    const lines = [
        `✗ TURNO CANCELADO`,
        ``,
        `Hola ${data.customerName}, tu turno ha sido cancelado.`,
        ``,
        `DETALLES DEL TURNO CANCELADO`,
        `─────────────────────────`,
